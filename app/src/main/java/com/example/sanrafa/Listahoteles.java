...
public class Listahoteles extends AppCompatActivity {
    ...
    public void crearlistadeHoteles(){
        ...
        listahoteles.add(new Hotel("Hotel PERLA BLANCA","160000/pareja","Este lindisimo apartamento está perfectamente equipado hasta para 6-8 personas. "," 310-4916005","Calle Alto de la Virgen",4,R.drawable.hotel7));
