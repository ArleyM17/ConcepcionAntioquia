...
public class Listasitios extends AppCompatActivity {
    ...
    public void crearlistadeSitios(){
        listasitios.add(new Sitios("IGLESIA INMACULADA","La única iglesia del pueblo fue construida en 1814, no obstante la parroquia existiera desde desde el 1774. Presenta una clásica estructura de tres naves con columnas portantes y un lindo altar central.","3126102598","Parque Central",4,R.drawable.sitio2));
        ...
        listasitios.add(new Sitios("CASCADA MATASANOS","Un lugar único por su naturaleza, un lugar que sin duda alguna te atrapará y te conectará con la paz y la tranquilidad que genera estas tres caídas de agua.","3126102598","vereda Santa Ana  a 6.3 Kilómetros  del Municipio de Concepción",5,R.drawable.matasanos));
    }
}