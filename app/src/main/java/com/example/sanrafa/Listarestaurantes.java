...
public class Listarestaurantes extends AppCompatActivity {
    ...
    public void crearlistadeRestaurantes(){
        ...
        listarestaurantes.add(new Restaurante("RESTAURANTE CAFETTO","15000","Un lugar diferente para compartir: creado por Santiago, su objetivo principal es ofrecer una gran variedad de bebidas y comidas, entre las cuales tortillas, sándwiches y pizzas (hay opciones vegetarianas). La comida puede ser acompañada con ricos batidos, granizados y licores. La especialidad de Cafetto es el café cultivado en el mismo municipio, que queda plasmado en su lema \"Que nunca nos falte fe, amor y café\"." ,"319-5104046","Carrera Santander",5,R.drawable.cafeto));
